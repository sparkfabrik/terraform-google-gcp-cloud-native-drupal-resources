...
|------|-------------|------|---------|:--------:|
| <a name="input_bucket_additional_transfer_job_excluded_prefixes"></a> [bucket\_additional\_transfer\_job\_excluded\_prefixes](#input\_bucket\_additional\_transfer\_job\_excluded\_prefixes) | A list of additional object prefixes to exclude from the transfer job for all buckets created by this module. | `list(string)` | `[]` | no |
...
| <a name="input_cloudsql_dumps_bucket_name"></a> [cloudsql\_dumps\_bucket\_name](#input\_cloudsql\_dumps\_bucket\_name) | The custom name for the CloudSQL dumps bucket. If specified, the bucket name will be '<cloudsql\_dumps\_bucket\_name>-<random\_suffix>'. If not specified, the default naming will be used. | `string` | `""` | no |
| <a name="input_cloudsql_dumps_environment"></a> [cloudsql\_dumps\_environment](#input\_cloudsql\_dumps\_environment) | The environment identifier for the CloudSQL dumps bucket. If specified, the bucket name will be '<project\_id>-cloudsql-dumps-<environment>-<random\_suffix>'. | `string` | `""` | no |
...
| <a name="input_permissions_refresh_id"></a> [permissions\_refresh\_id](#input\_permissions\_refresh\_id) | Optional identifier used to force Terraform to rerun the proxy/grant scripts without recreating users. Change the value whenever you need to reapply permissions. | `string` | `""` | no |
...
| <a name="module_drupal_databases_and_users"></a> [drupal\_databases\_and\_users](#module\_drupal\_databases\_and\_users) | github.com/sparkfabrik/terraform-google-gcp-mysql-db-and-user-creation-helper | 0.6.0 |
<!-- END_TF_DOCS -->
