...
[Compare with previous version](https://github.com/sparkfabrik/terraform-google-gcp-cloud-native-drupal-resources/compare/1.2.1...1.2.2)

- refs platform/board#4307: Upgrade module `terraform-google-gcp-mysql-db-and-user-creation-helper` to `0.5.3`, fixing issue with `REVOKE cloudsqlsuperuser`.
...
- Upgrade module `terraform-google-gcp-mysql-db-and-user-creation-helper` to `0.5.2`, fixing `REVOKE cloudsqlsuperuser`.
...
[Compare with previous version](https://github.com/sparkfabrik/terraform-google-gcp-cloud-native-drupal-resources/compare/0.23.0...0.24.0)

- Add support for Redis secret creation per project, the secret contains the Redis host and port.

## [0.23.0] - 2025-04-08

[Compare with previous version](https://github.com/sparkfabrik/terraform-google-gcp-cloud-native-drupal-resources/compare/0.22.1...0.23.0)

- Fix unique namaspace values
...
- Add `network-policy-allow-acme` to allow ACME traffic from ingress controller
